import {
  ...
  ThreadMessageUserDeliveryFailedPayload as ContractsThreadMessageUserDeliveryFailedPayloadSchema,
...
export const ThreadMessageUserDeliveryFailedPayload =
  ContractsThreadMessageUserDeliveryFailedPayloadSchema;
