...
const RuntimeEventRawSource = Schema.Union([
  ...
  Schema.Literal("pi.workflow.artifact"),
...
export const ThreadTokenUsageSnapshot = Schema.Struct({
  ...
  cachedWriteTokens: Schema.optional(NonNegativeInt),
  ...
  lastCachedWriteTokens: Schema.optional(NonNegativeInt),
  ...
  modelName: Schema.optional(TrimmedNonEmptyStringSchema),
